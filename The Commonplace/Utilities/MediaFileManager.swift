...
struct MediaFileManager {
    ...
    static var attachmentsURL: URL { containerURL.appendingPathComponent("media/attachments") }
    ...
    enum MediaType {
        ...
        case video
        case thumbnail
        case attachment(extension: String)
        ...
        var directory: URL {
            ...
            case .attachment:  return MediaFileManager.attachmentsURL
            }
        }
        ...
        var fileExtension: String {
            ...
            case .attachment(let ext):      return ext
            }
        }
    }
