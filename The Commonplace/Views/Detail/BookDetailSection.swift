...
struct BookDetailSection: View {
    ...
    // MARK: - Status Section
        ...
        var statusSection: some View {
            SlidingPillPicker(
                options: [
                    .init(label: "Reading List", value: "readingList", icon: "bookmark",        selectedColor: mediaStatusColor(for: "readingList", theme: themeManager.current)),
                    .init(label: "Reading",      value: "reading",     icon: "book",            selectedColor: mediaStatusColor(for: "reading",     theme: themeManager.current)),
                    .init(label: "Finished",     value: "finished",    icon: "checkmark.circle", selectedColor: mediaStatusColor(for: "finished",    theme: themeManager.current))
                ],
