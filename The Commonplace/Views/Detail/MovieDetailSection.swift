...
struct MovieDetailSection: View {
    ...
    var metadataBlock: some View {
        VStack(spacing: 6) {
            ...
            // Metadata row — free floating, dot separated
            metaLine
                .frame(maxWidth: .infinity, alignment: .center)
